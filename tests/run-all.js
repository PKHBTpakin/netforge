...
const FILES = ['save-load.test.js', 'ui-stability.test.js', 'regression-fixes.test.js', 'library-util.test.js', 'ux-features.test.js', 'cli-naming.test.js', 'scenarios.test.js', 'labguide.test.js', 'wording.test.js'];
