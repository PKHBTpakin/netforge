...
function labHtml() {
    ...
    var css =
        'body{font-family:"TH Sarabun New","Sarabun",system-ui,sans-serif;font-size:22px;' +
        'line-height:1.75;color:#1a1a1a;max-width:1080px;margin:0 auto;padding:28px 20px 60px}' +
        ...
        'font-family:Consolas,"DejaVu Sans Mono",monospace;font-size:16.5px;line-height:1.6;margin:0}' +
        '.copy{position:absolute;top:8px;right:8px;background:#2E5C8A;color:#fff;border:0;' +
        'border-radius:5px;padding:8px 16px;font-size:16px;cursor:pointer;font-family:inherit}' +
        ...
        'code{background:#EEF1F5;padding:1px 5px;border-radius:3px;font-size:18px}' +
    ...
    p('<h2>ตารางการแบ่ง Subnet</h2><table><tr><th>VLAN</th><th>Department</th><th>Hosts</th>',
      '<th>Network</th><th>Gateway<br><span style="font-weight:400;font-size:17px">Host แรก</span></th>',
    ...
    p('</table><p style="color:#5A5A5A;font-size:19px">Gateway ของแต่ละแผนกคือ Host หมายเลขแรก',
    ...
    p('<p style="margin-top:34px;color:#5A5A5A;font-size:19px">สร้างโดย NetForge ',
