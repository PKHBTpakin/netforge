...
function maxBottomPanelHeight() {
    ...
    /* ตอนกดขยายคือตอนที่ผู้ใช้ตั้งใจจะ "อ่านตาราง" ไม่ได้จะดูผัง
       จึงให้กินพื้นที่ทำงานทั้งหมด เหลือไว้แค่ 8px พอให้เส้นแบ่งยังลากได้
       เดิมกันที่ให้ผังไว้ 70-110px ซึ่งไม่ได้ช่วยอะไร เพราะผังสูงเท่านั้นก็ดูไม่รู้เรื่องอยู่ดี
       แต่กลับไปกินที่ของตารางที่ผู้ใช้กำลังพยายามอ่าน */
    return Math.max(260, Math.round(avail - 8));
}
